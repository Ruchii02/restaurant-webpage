        ...
        <div className="container py-16 sm:py-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4
               ...
               <div className='space-y-7 text-dark order-2 sm:order-1'>
                 <h1 data-aos = "fade-up" className='text-5xl'>Welcome to <span className='text-primaryDark font-cursive text-7xl'>TastyTransit</span> <br /> Fresh & Healthy <br></br> Meal Plan
